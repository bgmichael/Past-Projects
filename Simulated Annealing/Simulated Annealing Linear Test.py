...
def main():
    ...
    for type in method_list:
        ...
        for n in length_list:
            ...
            average_time = sum(timevalues) / 30
            average_guess = guess // 30
...
if __name__ == "__main__":
    ...
    # print("Linear Time List: ", LinearTimeList)
    # print("Linear Guess List", LinearGuessList)
    # #print(average_list)
    #
    # plt.plot(length_list, LinearTimeList, label="Linear Time")
    # plt.legend(loc='upper right')
    # plt.xlabel('Input Size')
    # plt.ylabel('TIME(seconds)')
    # plt.title('Linear Cooling Time')
