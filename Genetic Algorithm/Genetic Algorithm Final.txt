...
'''
PAUL-HUGO DLUGY-HEGWER      BEN MICHAEL     JASON DEGRACE
'''
...
def Genetic_Algorithm_without_restart(n):
    ...
    return best_fit, best_fitness, refresh, iterator


def Genetic_Algorithm(n, generation_number):
...
def main():
    ...
    time_val = []
    single_time_val = 0
    size_list = [10, 20, 30, 40, 50]#, 60]#, 70, 80]
    number_restart = 0
    ...
    for size in size_list:
        ...
        for i in range(30):
            ...
            problem_list = generate_random_problem(size)
            guaranteeASolution(problem_list)
            # print("Problem_List: ", problem_list)
            test = Genetic_Algorithm(problem_list, 1000)
            number_restart = number_restart + test[2]
            number_generations = number_generations + test[3]
            # print(test)
            endTime = time.process_time()
            timevalue = (format(endTime - startTime, "6.4f"))
            single_time_val = single_time_val + float(timevalue)

        avg_restarts = number_restart / 30
        restart_list.append(avg_restarts)
        avg_generations = number_generations / 30
        avg_time = single_time_val / 30
        test_vals_1000.append(avg_time)
        generations_1000.append(avg_generations)


    print(test_vals_1000)
    ...
    for size in size_list:
        ...
        for i in range(30):
            ...
            guaranteeASolution(problem_list)
            # print("Problem_List: ", problem_list)
            test = Genetic_Algorithm(problem_list, 200)
            # print(test)
            endTime = time.process_time()
            timevalue = (format(endTime - startTime, "6.4f"))
            single_time_val = single_time_val + float(timevalue)
    ...
    for size in size_list:
        ...
        for i in range(30):
            ...
            guaranteeASolution(problem_list)
            # print("Problem_List: ", problem_list)
            test = Genetic_Algorithm(problem_list, 500)
            # print(test)
            endTime = time.process_time()
            timevalue = (format(endTime - startTime, "6.4f"))
            single_time_val = single_time_val + float(timevalue)
        ...
        avg_time = single_time_val / 30
        test_vals_500.append(avg_time)

    print(test_vals_200)

    test_vals_no_restart = []
    fail_list = []
    fail = 0
    ...
    for size in size_list:
        for i in range(30):
            ...
            guaranteeASolution(problem_list)
            # print("Problem_List: ", problem_list)
            test = Genetic_Algorithm_without_restart(problem_list)
            if test == 0:
                fail = fail + 1
            # print(test)
            endTime = time.process_time()
        ...
        avg_time = single_time_val / 30
        test_vals_no_restart.append(avg_time)
        fail_list.append(fail)

    #print(test_vals)


    plt.plot(size_list, test_vals_1000, label="Time")
    plt.legend(loc='upper right')
    plt.xlabel('Input Size')
    plt.ylabel('Time')
    plt.title('Genetic Algorithm Time 1000 Generations')
    plt.show()

    plt.plot(size_list, generations_1000, label="Number of Generations")
    plt.legend(loc='upper right')
    plt.xlabel('Input Size')
    plt.ylabel('Generations')
    plt.title('Genetic Algorithm Generations')
    plt.show()

    plt.plot(size_list, restart_list, label="Number of Restarts")
    plt.legend(loc='upper right')
    plt.xlabel('Input Size')
    plt.ylabel('Restarts')
    plt.title('Genetic Algorithm Restarts')
    plt.show()

    plt.plot(size_list, test_vals_200, label="Time")
    plt.legend(loc='upper right')
    plt.xlabel('Input Size')
    plt.ylabel('Time')
    plt.title('Genetic Algorithm Time 200 Generations')
    plt.show()

    plt.plot(size_list, test_vals_500, label="Time")
    plt.legend(loc='upper right')
    plt.xlabel('Input Size')
    plt.ylabel('Time')
    plt.title('Genetic Algorithm Time 500 Generations')
    plt.show()

    plt.plot(size_list, test_vals_no_restart, label="Time without restarts")
    plt.legend(loc='upper right')
    plt.xlabel('Input Size')
    plt.ylabel('Time')
    ...
    plt.plot(size_list, fail_list, label="Fail List")
    plt.legend(loc='upper right')
    plt.xlabel('Input Size')
    plt.ylabel('Fails')
    plt.title('Genetic Algorithm Fails')
    plt.show()
